...
<div id="page-wrapper" style="min-height: 172px;">
			<div class="main-page">
				<div class="tables">
					...
					<h2 class="title1">المجموعات</h2>



					<div class="bs-example widget-shadow" data-example-id="contextual-table">
						<h4 style="display:inline-block">المجموعات :</h4>
						<?php
             $permission_create = Permission::where('name','المجموعات')->where('action','create')->first();
            if(check_permission($admin->group_id,$permission_create->id)){
             ?>

            <a class="btn btn-default" href="<?=$location;?>/views/admin/group/create.php" style="background-color: #F2B33F;float: left;display: inline-block;">
            ...
            <?php } ?>
                ...
                <thead>
                  ...
                  <tbody>
                    <?php $i=1;foreach ($allgroups as $key) {?>
                      ...
                      <tr>
                        ...
                        <td>
                            <?php
                           $permission_edit = Permission::where('name','المجموعات')->where('action','update')->first();
                          if(check_permission($admin->group_id,$permission_edit->id)){
                           ?>
                           <a href="<?=$location?>/views/admin/group/edit.php?id=<?=$key->id;?>">
                        ...
                        <td>
                           <a href="<?=$location?>/views/admin/permission/?id=<?=$key->id;?>">
                        	<i class="fa fa-fw fa-edit"></i>
                        </td>
