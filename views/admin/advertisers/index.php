...
<div id="page-wrapper" style="min-height: 172px;">
			<div class="main-page">
                ...
                <thead>
                  ...
                  <tbody>
                    <?php $i=1;foreach ($allusers as $key) {?>
                      <tr>
                        <th><?=$i;?></th>
                        <td><?=$key->name;?></td>
                        <td><?=$key->email;?></td>
                        ...
                        <td class="activeAdmin">
                          <?php
                          if(empty($key->logo) || empty($key->front)  || empty($key->back)  || empty($key->cr) || empty($key->company))
                          {
                          ...
                          }else
                          {
                            ...
                            ?>
                               <?php
                        $permission_edit = Permission::where('name','المعلنين')->where('action','active')->first();
                        ...
                        <td>
                           <a href="<?=$location?>/views/admin/advertisers/edit.php?id=<?=$key->id;?>">
                          <i class="fa fa-fw fa-edit"></i>
                        </td>

                        <td>
                                 <?php
                           $permission_delete = Permission::where('name','المعلنين')->where('action','delete')->first();
