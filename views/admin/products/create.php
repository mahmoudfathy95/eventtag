...
<div class="main-page">
                ...
                <form  class="form-horizontal" id="create" method="post" role="form" enctype='multipart/form-data'>
                  ...
                  <div class="form-group">
										<label class="col-md-2 control-label">الاقسام الرئيسية</label>
										<div class="col-md-8">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <div class="input-group">
                            ...
                            <textarea name="details" class="form-control tab-child" id="details" cols="150" rows="10"></textarea>                            <span id="details-error" style="color:red;"></span>
                           </div>
                          </div>
                        </div>
