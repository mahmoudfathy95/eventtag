...
<div id="page-wrapper">
  <section class="content-header">
    <ol class="breadcrumb">
      ...
      <li><a href="#">  update walk through</a></li>
    </ol>
  </section>
<div class="main-page">
                ...
                <form  class="form-horizontal" id="update" method="post" role="form" enctype='multipart/form-data'>
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control1 tab-child" id="title" value="<?=isset($item->title)?$item->title:'';?>">
