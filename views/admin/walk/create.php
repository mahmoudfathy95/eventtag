...
<div class="main-page">
                ...
                <form  class="form-horizontal" id="create" method="post" role="form" enctype='multipart/form-data'>
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control1 tab-child" id="title">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <div class="input-group">
                          ...
                          <textarea name="details" class="form-control tab-child" id="details" cols="150" rows="10"></textarea>
