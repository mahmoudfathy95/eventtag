                    ...
                    <div class="col-md-8">
                      <div class="input-group">
                        ...
                        <select name="group_id" class="form-control1 tab-child" id="group_id">
                          ...
                          {
                            ?>
                            <option <?=$key->id==$item->group_id?'selected':'';?> value="<?=$key->id;?>"><?=$key->name;?></option>
                        <?php } ?>
                        </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <div class="input-group">
                        ...
                        <input type="text" name="username" class="form-control1 tab-child" id="username" value="<?=isset($item->username)?$item->username:'';?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <div class="input-group">
                        ...
                        <input type="email" name="email" class="form-control1 tab-child" id="email" value="<?=isset($item->email)?$item->email:'';?>">
                    ...
                    <div class="col-md-8">
                      <div class="input-group">
                        <span class="input-group-addon">
                          ...
                          <input type="text" name="password" class="form-control1 tab-child" id="password" value="<?=isset($item->password)?$item->password:'';?>">
